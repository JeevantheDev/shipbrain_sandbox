...
Change the main checkout heading color in index.html from dark gray (#333) to blue (#0066cc) as per the specification. Ensure no other layout or file changes are made.
